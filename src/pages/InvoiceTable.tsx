...
const InvoiceTable = () => {
  ...
  const [invoices, setInvoices] = useState<Invoice[]>([
    { id: 1, customerName: "John Doe", date: "2023-01-01", amount: 1000, status: "Paid" },
    { id: 2, customerName: "Jane Smith", date: "2023-01-02", amount: 2000, status: "Unpaid" },
  ]);
  const [currentInvoice, setCurrentInvoice] = useState<Invoice>({ id: 0, customerName: "", date: "", amount: 0, status: "" });
  ...
  return (
    <>
      <div style={{display:'flex',justifyContent:'space-between', marginBottom: '20px'}}>
        <div>Invoices</div>
        <div>
          <Button variant="outlined" onClick={() => handleOpen({ id: 0, customerName: "", date: "", amount: 0, status: "" })}>+Add Invoice</Button>
      ...
      >
        ...
        >
          ...
          <form>
            ...
            <TextField fullWidth label="Amount" margin="normal" value={currentInvoice.amount} onChange={(e) => setCurrentInvoice({ ...currentInvoice, amount: parseFloat(e.target.value) })} />
