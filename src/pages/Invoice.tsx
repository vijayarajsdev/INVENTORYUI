...
const Invoice = () => {
  ...
  const handleCreateInvoice = () => {
    navigate("/gst-invoice"); // Navigate to the GST invoice template page
  };
  ...
  return (
    <>
      ...
      <InvoicesTable rows={invoices} onEdit={handleOpen} />
      ...
      <Modal open={open} onClose={handleModalClose} disableEscapeKeyDown>
        <Box
          ...
          <div
            ...
            <h2>
              {currentInvoice.customerName ? "Edit Invoice" : "Add Invoice"}
            </h2>
